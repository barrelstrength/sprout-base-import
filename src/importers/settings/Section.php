...
class Section extends SettingsImporter
{
    ...
    public function resolveNestedSettings($section, $settings)
    {
        ...
        foreach ($settings['entryTypes'] as $key => $entryTypeSettings) {
            ...
            $typeModel = SproutBaseImport::$app->importers->getImporter($settings['entryTypes'][$key]);

            SproutBaseImport::$app->settingsImporter->saveSetting($settings['entryTypes'][$key], $typeModel);
        }
